"implements Sankey Modified to allow python 3"
...
#when running you need to run,
# ensure you both ipysankeywidget and ipywidgets installed using pip.
# next run the command,
# jupyter nbextension enable --py --sys-prefix ipysankeywidget
# first, and then in the same environment run
# jupyter notebook
